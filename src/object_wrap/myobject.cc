...
void MyObject::Init(napi_env env, napi_value exports)
{
  ...
  napi_value cons;
  NAPI_CALL_RETURN_VOID(env, napi_define_class(env, "MyObject", -1, New, nullptr, 3, properties, &cons), "Unable to define class.");

  NAPI_CALL_RETURN_VOID(env, napi_create_reference(env, cons, 1, &constructor), "Unable to create reference.");

  NAPI_CALL_RETURN_VOID(env,
                        napi_set_named_property(env, exports, "MyObject", cons), "Unable to set named property.");
}
