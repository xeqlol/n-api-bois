...
napi_value TestGetElement(napi_env env, napi_callback_info info)
{
  ...
  NAPI_ASSERT(env, valuetype0 == napi_number, "Wrong type of arguments. Expects an integer as second argument.");

  napi_valuetype valuetype1;
  NAPI_CALL(env, napi_typeof(env, args[1], &valuetype1));

  NAPI_ASSERT(env, valuetype1 == napi_number, "Wrong type of arguments. Expects an integer as second argument.");
